...
## This is bad, but neither Gemini, ChatGPT, or Claude can figure out how to fix it
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[0]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[1]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[2]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[3]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[4]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[5]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[6]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets ad/dataBus[7]];
